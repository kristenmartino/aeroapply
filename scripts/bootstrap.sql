-- AeroApply — canonical database schema (source of truth for the data model).
-- Dev: run against the local Docker Postgres (see infra/docker-compose.yml).
-- Prod: apply via Alembic migration generated from this schema.
